              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item label-width="60px" label="Author:" class="postInfo-container-item">
                    <el-select filterable v-model="postForm.author" :remote-method="getRemoteUserList" filterable
...
<script>
  import Tinymce from '$demo/components/Tinymce'
  import Upload from '$demo/components/Upload/SingleImage3'
  import MDinput from '$demo/components/MDinput'
  import Sticky from '$components/Sticky' // 粘性header组件
  import { validURL } from '$demo/utils/validate'
